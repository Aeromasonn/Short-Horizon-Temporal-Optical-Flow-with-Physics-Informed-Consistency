...
CHECKPOINT_NAME = 'fullpipeline_v11_latest.pth'
BEST_CHECKPOINT_NAME = 'fullpipeline_v11_best.pth'
AUTO_MASK_EPS = 1e-3
...
def photometric_loss_v11(
    ...
    """
    v11 keeps the v10 robust self-supervised formulation:
...
class Trainer:
    ...
    def train_step(self, batch, epoch_idx=0):
        ...
        loss_self = photometric_loss_v11(
            img_src,
            img_tgt,
            pred,
            valid=valid,
